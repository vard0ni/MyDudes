...
class PostView(CreateRetrieveUpdateDestroy):
    ...
    permission_classes_by_action = {'get': [permissions.AllowAny],
                                    'update': [IsAuthor],   # если автор, то может обновлять и удалять
                                    'destroy': [IsAuthor]}
...
class CommentsView(CreateUpdateDestroy):
    ...
    permission_classes_by_action = {'update': [IsAuthor],   # если автор, то может обновлять и удалять
                                    'destroy': [IsAuthor]}
    ...
    def perform_destroy(self, instance):
        # физически не удаляем, а скрываем
